...
const ContactUs = () => {
    return (
        <div style={
        ...
        } className='contact__use rounded-2xl py-16 lg:py-20'>
            <div className="container">
                ...
                <form className='mx-auto'>
                    ...
                    <div className="contact__input w-6/12 w-6/12 mx-auto py-4 text-center">
